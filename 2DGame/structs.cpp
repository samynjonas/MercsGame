...
//-----------------------------------------------------------------
// SpriteInfo Constructors
//-----------------------------------------------------------------

SpriteInfo::SpriteInfo()
	: SpriteInfo(nullptr, Rectf{0, 0, 0, 0}, 0, 0, 0, 0)
{
}

SpriteInfo::SpriteInfo(Texture* texture, Rectf sourceRect, int colls, int rows, float fps, float scale)
	: texture{ texture }
